...
public:
     ...
     */
    core::BlockchainManager& getBlockchainManager();

    /**
     * @brief Get the database manager
     * @return Reference to the database manager
     */
    core::DatabaseManager& getDatabaseManager();
...
namespace managers {
    ...
    inline core::BlockchainManager& blockchain() { return SDK::getInstance().getBlockchainManager(); }
    inline core::DatabaseManager& database() { return SDK::getInstance().getDatabaseManager(); }
    inline core::AssetManager& asset() { return SDK::getInstance().getAssetManager(); }
    inline core::SecurityManager& security() { return SDK::getInstance().getSecurityManager(); }
    inline core::NFTManager& nft() { return SDK::getInstance().getNFTManager(); }
    inline core::IPFSManager& ipfs() { return SDK::getInstance().getIPFSManager(); }
    inline core::NetworkManager& network() { return SDK::getInstance().getNetworkManager(); }
    inline core::WalletManager& wallet() { return SDK::getInstance().getWalletManager(); }
}
