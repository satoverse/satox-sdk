...
This directory contains the C# language binding for the Satox SDK.

## Status
- Production readiness: Partial (see verification script)
- Maintainer: Satox SDK Team
...
- Build with `dotnet build Satox.csproj`.
